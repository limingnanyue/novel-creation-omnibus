...
> **写小说，从0到完本，一个Skill搞定。**
> 长篇网文、短篇虐文、番茄爆文、白描写作、规则怪谈、无限流、悬疑推理、末世废土——40套创作工具+模型专属优化+平台适配，按需加载，即用即走。
